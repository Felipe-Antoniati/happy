...
export default function OrphanageData() {
  ...
  async function handleSelectImages() {
    ...
    if(status !== 'granted') {
      alert('Sorry, but we need permission for post yours photos');
      return;
    }
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
     ...
     />
      ...
      <Text style={styles.title}>Visitations</Text>
      ...
      <RectButton style={styles.nextButton} onPress={handleCreateOrphange}>
