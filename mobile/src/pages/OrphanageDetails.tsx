        ...
        <View style={styles.scheduleContainer}>
          ...
          { orphanage.open_on_weekends ? (
            <View style={[styles.scheduleItem, styles.scheduleItemGreen]}>
              ...
              <Text style={[styles.scheduleText, styles.scheduleTextGreen]}>We server Weekends</Text>
            </View>
            ) : (
            <View style={[styles.scheduleItem, styles.scheduleItemGreen]}>
              <Feather name="info" size={40} color="#FF669D" />
              <Text style={[styles.scheduleText, styles.scheduleTextRed]}>We don't server Weekends</Text>
            </View>
          )}
